...
export type GetOptionValue<O = any, T = any> = (key: O extends Option<infer K>[] ? K : never) => T;

export async function promptMissingOptions<O extends Option<K>[], K extends string>(
  flags: O,
  cli: any
) {
