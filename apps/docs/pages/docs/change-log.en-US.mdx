...
export const getStaticProps = ({ params }) => {
  return fetch(`https://api.github.com/repos/carlosbaraza/lostdock/releases`)
    .then(res => res.json())
...
Please visit the [LostDock release page](https://github.com/carlosbaraza/lostdock/releases) for all history releases.
